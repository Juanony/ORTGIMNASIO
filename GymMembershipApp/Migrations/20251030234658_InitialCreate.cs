        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MembershipStartDate = table.Column<DateTime>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "Id", "Description", "DurationInDays", "IsActive", "Name", "Price" },
                values: new object[,]
                {
                    { 1, "Access to gym for 30 days", 30, true, "Monthly", 50.00m },
                    { 2, "Access to gym for 90 days with 10% discount", 90, true, "Quarterly", 135.00m },
                    { 3, "Access to gym for 365 days with 20% discount", 365, true, "Annual", 480.00m }
                });
